...
//         //HIRE starting the employee function
//         HIRE() {
//             this.name= 'Chad';
//             this.id =
//         }
...
class __Employee__ {
    //! constructor
    getName(/*__Name__, __ID__, __Email__, __getRole__*/) {
        this.__Name__ = "Mike";
        // this.__ID__ = __Engineer__;
    ...
    //Hire Employee function within the class
    /*__Name__, __ID__, 
    __Email__, __getRole__*/
    ...
    getRole() {
        ...
        } else  (this.__Employee__.__Intern__){
